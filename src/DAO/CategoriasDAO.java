...
//        String where = "";
            ...
            String sql = "SELECT idcategoria,idcategoria,titulo,descricao FROM categorias WHERE titulo like ? OR descricao like ? ORDER BY titulo";
...
//                                                        1              2                     3
    ...
    public boolean temDesenvolvedor(String id) {
        boolean tem = false;


        String sql = "SELECT * FROM desenvolvedores WHERE idcategoria= ? ";
